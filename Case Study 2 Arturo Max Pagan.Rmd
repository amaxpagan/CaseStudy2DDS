...
After analysis, evidence suggests that the three most telling factors of employee attrition are monthly income, job role, and overtime. Monthly income was shown to be significantly impactful when it proved to have a statistically significant difference in means between employees who had left and employees who stayed. While there were other factors thst demonstrated more statistical significance in this area, like job involvement, those factors were much less practically interpretable. Job involvement, for example had only 4 possible outcomes, 1 through 4. While it is true that employees that left are associated with lower job involvement, this difference in means is a fraction. Therefore, if we saw an employee's Job Involvement by itself, we wouldn't be able to strongly interpret what it means for attrition. It is when we combine job involvement with other variables that its predictive power shines through. The next most important factor in determining attrition os job role. With sales representatives having high attrtion rates at 45%, whereas research directors just barely have a rate higher than 1%, this speaks to association between job role and attrition. And finally, the next most important factor in determining attrition is overtime. Employees with overtime have a 31% rate of attrition, compare the the 9.7% rate for employees without overtime. If you want to determine an employee's likelihood of attrtion, based on the data we have, it is incredibly prudent to look at their job role, their income, and their overtime. Runners-up for importance include age and marital status.
